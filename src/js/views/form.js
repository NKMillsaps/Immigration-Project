							...
							<div className="text-justify mt-5">
								<form>
									...
									<div className="form-row">
										<div className="col-md mb-3">
											<label htmlFor="validationDefault03">
												Passport/Travel Document Series/Number
											</label>
											<input
												type="text/number"
												className="form-control"
									...
									<div className="form-row">
										<div className="col-md mb-3">
											<label htmlFor="validationDefault03">
												Date of your last arrival to the U.S.
											</label>
											<input
												type="date"
												className="form-control"
									...
									<div className="form-row">
										<div className="col-md mb-3">
											<label htmlFor="validationDefault03">
												New status and effective date of change
											</label>
											<input
												type="date"
												className="form-control"
									...
									<div className="form-row">
										The total number of people (incl uding me) in this application is:{" "}
										<input Number /> (Complete the supplement for each co-applicant.)&nbsp;
									</div>
									<div className="form-row">
										<div className="col-md-6 mb-3">
											<label htmlFor="validationDefault03">
												1. I/We request that my/our current or requested status (Visa) be
												extended until
											</label>
											<input
												type="date"
									...
									<div className="form-row">
										<legend className="col-form-label  pt-0">
											2.a. Is this application based on an extension or change of status already
									...
									<div className="form-row">
										<legend className="col-form-label  pt-0">
											3.a. Is this application based on a separate petition or application to
											provide your spouse, child, or parent an extension or change of status?
										</legend>
									...
									<div className="form-row">
										...
										<div className="col-md mb-3">
											<label htmlFor="validationDefault02">
												First and Last Name of Petitioner/Applicant
											</label>
											<input
												type="text"
												className="form-control"
									...
									<div className="form-row">
										If the petition or application is pending with USCIS, also provide the following
										information
									</div>
									<div className="form-row">
										<div>
									...
									<div className="form-row">
										Provide your employment history for the last 5 (five) years inside or outside of
										the U.S. Provide the most recent emplyment first.
									</div>
									...
									<div className="form-row">
										<div className="col-md-4 mb-3">
											<label htmlFor="validationDefault01">
												PARENT I. Last Name (Family name)
											</label>
											<input
												type="text"
												className="form-control"
									...
									<div className="form-row">
										<div className="col-md mb-3">
											<label htmlFor="validationDefault01">
												PARENT II. Last Name (Family name)
											</label>
											<input
												type="text"
												className="form-control"
									...
									<div className="form-row">
										<div className="col-md mb-3">
											<label htmlFor="validationDefault03">
												Current City/Town of Residence (if living)
											</label>
											<input
												type="text"
												className="form-control"
