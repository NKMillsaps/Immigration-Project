			...
			<div className="container1">
				<div className="text-justify mt-5">
					<form>
						...
						<div className="form-row">
							<div className="col-md mb-3">
								<label htmlFor="inputAddress">U.S. Physical Address for the past 5 years</label>
								<input
									type="text"
									className="form-control"
									id="inputAddress"
						...
						<div className="form-row">
							<div className="col-md mb-3">
								<label htmlFor="inputAddress">Your Last Address Outside U.S.A.</label>
								<input
									type="text"
									className="form-control"
									id="inputAddress"
						...
						<div className="form-row">
							...
							<div className="col-md-3 mb-3">
								<label htmlFor="validationDefault03">State/Province/Region/Area</label>
								<input type="text" className="form-control" id="validationDefault03" required />
							</div>
							<div className="col-md-3 mb-3">
